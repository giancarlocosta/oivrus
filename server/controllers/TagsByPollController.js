...
*/
class TagsByPollController extends ModelController {
  ...
  */
  find(poll, options = {}) {
    ...
    return co(function* () {
      ...
      const filters = { poll: db.models.uuidFromString(poll) };
...
module.exports = TagsByPollController;
