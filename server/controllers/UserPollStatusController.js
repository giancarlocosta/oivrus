...
*/
class UserPollStatusController extends ModelController {
  ...
  find(resourceId, options) {
    ...
    return co(function* () {
      ...
      if (!resourceId) {
        ...
        const total = yield db.client.execute(`SELECT count(*) FROM user_poll_status`, [], {});
...
module.exports = UserPollStatusController;
